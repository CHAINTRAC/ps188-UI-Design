...
import { orgAuditLog } from "../../data/superAdminData";
...
export default function AuditTrail() {
  ...
  const rows = filter === "all" ? orgAuditLog : orgAuditLog.filter((a) => a.type === filter);

  return (
    <>
      <Topbar title="Audit Trail" subtitle="All regions · every action across the organization" />
